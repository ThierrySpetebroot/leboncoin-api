...
Item.prototype.getDetails = function (options) {
    var self = this;
    ...
    Object.assign(requestOptions, utils.requestOptions, (options) ? options : {});
    ...
    return new Promise(function(resolve, reject) {
        request.get(requestOptions, function (err, res) {
            ...
            self.date_expiration = new Date(entry.expiration_date);
...
Item.prototype.getPhoneNumber = function (options) {
    var self = this;
    return new Promise(function(resolve, reject) {
